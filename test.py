...
### Connexion ; décommenter les deux lignes pour l'utilisateur voulu et ne pas oublier de recommenter les 2 autres
# etudiant1
# password = pw[0]
...
def get_console_url(conn, vm_name:str):
    ...
    url = server.get_console_url(conn.compute, "novnc")
    print(url)
    return url['url']
### Admin only
